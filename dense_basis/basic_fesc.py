...
def makespec_fesc(
    ...
    lam, spec_noneb_dusty = sp.get_spectrum(
        tage=cosmo.age(zval).value + 1e-4, peraa=peraa
    )
...
def calc_fesc_posteriors(sedfit):
    ...
    """
    fesc_vals = get_quants_key(
        "fesc", 50, sedfit.chi2_array, sedfit.atlas, sedfit.norm_fac
    )
